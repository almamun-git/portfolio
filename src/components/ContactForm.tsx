    ...
    <form onSubmit={handleSubmit} className="w-full max-w-lg space-y-4" aria-describedby="contact-desc">
      ...
      <div className="flex items-center gap-4">
        <button 
          ...
          className="inline-flex items-center rounded-md bg-primary-600 text-white px-4 py-2 text-sm font-medium shadow hover:bg-primary-500 disabled:opacity-60 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500/50 transition-all duration-200"
        >
          {status==='sending' && (
