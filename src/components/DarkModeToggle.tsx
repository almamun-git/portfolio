...
export function DarkModeToggle() {
  ...
  return (
    ...
    >
      ...
      <svg className="h-5 w-5 dark:hidden" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2m0 16v2m10-10h-2M4 12H2m15.071 6.071-1.414-1.414M8.343 9.657 6.929 8.243m0 7.314 1.414-1.414M15.657 8.343l1.414-1.414"/></svg>
