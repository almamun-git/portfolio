...
export function Header() {
  return (
  <header className="sticky top-3 z-30 sm:mt-4 lg:mt-5 container-section flex items-center justify-between py-4 gap-6 backdrop-blur supports-[backdrop-filter]:bg-white/70 dark:supports-[backdrop-filter]:bg-neutral-900/70 border border-neutral-200/60 dark:border-neutral-800 rounded-xl transition-all duration-300">
