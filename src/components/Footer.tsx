    ...
    <footer className="relative mt-32 border-t border-neutral-200/60 dark:border-neutral-800 pt-16 pb-10 overflow-hidden">
      ...
      <div className="container-section relative z-10">
        <div className="grid gap-10 md:grid-cols-3">
          <div className="space-y-4">
            ...
            <div className="flex gap-4 text-neutral-500 dark:text-neutral-400">
              <a href={profile.links.github} target="_blank" rel="noreferrer" className="hover:text-primary-600 dark:hover:text-primary-400 transition-colors" aria-label="GitHub"><TechIcon name="Git/GitHub" size={20} /></a>
              <a href={profile.links.linkedin} target="_blank" rel="noreferrer" className="hover:text-primary-600 dark:hover:text-primary-400 transition-colors" aria-label="LinkedIn"><svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M4.98 3.5a2.5 2.5 0 11-.02 5.001 2.5 2.5 0 01.02-5zM3 9h4v12H3zM9 9h3.8v1.71h.05c.53-.95 1.83-1.96 3.77-1.96 4.03 0 4.78 2.65 4.78 6.1V21h-4v-5.16c0-1.23-.02-2.81-1.71-2.81-1.71 0-1.97 1.34-1.97 2.72V21H9z"/></svg></a>
              <a href={`mailto:${profile.email}`} className="hover:text-primary-600 dark:hover:text-primary-400 transition-colors" aria-label="Email"><svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2Z"/><path d="m22 6-10 7L2 6"/></svg></a>
            </div>
          </div>
        ...
        <div className="mt-10 flex items-center justify-between gap-4 border-t border-neutral-200/60 dark:border-neutral-800 pt-6 text-xs text-neutral-500">
          ...
          <a href="#home" className="inline-flex items-center gap-1 rounded-md px-3 py-1.5 bg-neutral-900 text-white dark:bg-neutral-200 dark:text-neutral-900 text-xs font-medium hover:bg-primary-600 dark:hover:bg-primary-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500/50 transition-colors">Top ↑</a>
        </div>
      </div>
    </footer>
  );
