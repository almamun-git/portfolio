        ...
        <div className="grid gap-10 md:grid-cols-3">
          <div className="space-y-4">
            ...
            <div className="flex gap-4 text-neutral-500 dark:text-neutral-400">
              ...
              <a href={profile.links.linkedin} target="_blank" rel="noreferrer" className="hover:text-primary-600 dark:hover:text-primary-400 transition-colors" aria-label="LinkedIn"><svg className="h-5 w-5" role="img" viewBox="0 0 24 24" fill="currentColor"><title>LinkedIn</title><path d="M4.98 3.5a2.5 2.5 0 11-.02 5.001 2.5 2.5 0 01.02-5zM3 9h4v12H3zM9 9h3.8v1.71h.05c.53-.95 1.83-1.96 3.77-1.96 4.03 0 4.78 2.65 4.78 6.1V21h-4v-5.16c0-1.23-.02-2.81-1.71-2.81-1.71 0-1.97 1.34-1.97 2.72V21H9z"/></svg></a>
              <a href={`mailto:${profile.email}`} className="hover:text-primary-600 dark:hover:text-primary-400 transition-colors" aria-label="Email"><svg className="h-5 w-5" role="img" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><title>Email</title><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2Z"/><path d="m22 6-10 7L2 6"/></svg></a>
            </div>
          </div>
